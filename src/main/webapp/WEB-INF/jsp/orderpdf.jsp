<%-- 
    ...
    Created on : Apr 23, 2021, 4:56:52 PM
    Author     : Anjali
--%>
...
<html>
	...
	<hr/>	
	<h5> Order ID:${requestScope.orderid}  </h5>
        <h5> Order Date: ${requestScope.orderdate}  </h5><br/> 
        <div class="text-center"> <a href="${contextPath}/Customer/${requestScope.orderid}/orderItems.pdf" class="btn btn-dark"> Generate Pdf</a></div><br/>
