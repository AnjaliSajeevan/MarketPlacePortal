<%-- 
    ...
    Created on : Apr 22, 2021, 11:23:10 PM
    Author     : Anjali
--%>
                ...
                <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12">
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <form:form class="form-horizontal" modelAttribute="addressbill" method="post"  action="${contextPath}/Customer/updateBillingAddress">      
                                <div class="row gutters">
